...
public class ModificarComponente {
    ...
    public ModificarComponente(String id, String pagina, String clase, ComponenteTitulo compTitulo, ComponenteParrafo compParrafo, ComponenteImagen compImagen, ComponenteVideo compVideo, ComponenteMenu compMenu) {
        this.id = id;
        this.pagina = pagina;
        this.clase = clase;
